...
const CommunityBanner = ({ language, communityTg, discordLink, faceitLink }) => {
    ...
    const platforms = [
        {
            ...
            color: '#ff5500',
            link: faceitLink || 'https://www.faceit.com/ru/club/44e432a6-3d12-49b8-b591-8b4f820e5d9e/parties',
            shortDesc: t.faceitDesc
        },
        {
            name: 'Discord',
            label: t.joinDiscord,
            ...
            color: '#5865F2',
            link: discordLink || 'https://discord.gg/gTkYrBDf',
            shortDesc: t.discordDesc
        },
        {
            name: 'Telegram',
            ...
            icon: <Send size={22} />,
            color: '#0088cc',
            link: communityTg || 'https://t.me/tigercasinoofficial',
            shortDesc: t.telegramDesc
        }
    ];
    ...
    return (
        <div style={{
            ...
            <div style={{
                ...
                <Users size={14} /> {t.communityLabel}
            </div>
