                                            ...
                                            {needsBotStart ? (
                                                <div style={{ background: 'rgba(255, 180, 0, 0.1)', border: '1px solid rgba(255, 180, 0, 0.2)', padding: '15px', borderRadius: '12px', textAlign: 'center' }}>
                                                    ...
                                                    <div style={{ display: 'flex', gap: '10px' }}>
                                                        ...
                                                        >
                                                            {t.openBotButton || 'Открыть бота'}
                                                        </button>
                                                        <button
                                                            onClick={handleTelegramSubscribe}
                                                            disabled={isSubmitting}
                                                            style={{ flex: 1, background: 'rgba(255,255,255,0.1)', color: '#fff', border: '1px solid rgba(255,255,255,0.1)', padding: '10px', borderRadius: '8px', fontWeight: '900', cursor: isSubmitting ? 'default' : 'pointer', fontSize: '0.85rem', opacity: isSubmitting ? 0.5 : 1, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '6px' }}
                                                        >
                                                            {isSubmitting ? <Loader2 size={16} className="animate-spin" /> : (t.verifySubscription || 'Проверить')}
                                                        </button>
                                                    </div>
                                                </div>
                                            ) : (
                                                <>
                                                    <div style={{ position: 'relative' }}>
                                                        <input
                                                            ...
                                                            value={telegramId}
                                                            onChange={(e) => setTelegramId(e.target.value.replace(/\D/g, ''))}
                                                            placeholder={t.telegramIdLabel || 'Твой Telegram ID (только цифры)'}
                                                            style={{
                                                                width: '100%',
                                                                background: 'rgba(0,0,0,0.3)',
                                                        ...
                                                        <button
                                                            ...
                                                            title={t.telegramIdHelp || 'Узнать свой Telegram ID'}
                                                            style={{ position: 'absolute', right: '10px', top: '50%', transform: 'translateY(-50%)', cursor: 'pointer', background: 'none', border: 'none', color: '#0088cc' }}
                                                        >
                                                            <HelpCircle size={18} />
                                                        </button>
                                                    </div>
                                                    <button
                                                        ...
                                                        style={{
                                                            ...
                                                            borderRadius: '10px',
                                                            fontWeight: '900',
                                                            cursor: isSubmitting || !telegramId ? 'default' : 'pointer',
                                                    ...
                                                    >
                                                        {isSubmitting ? <Loader2 size={18} className="animate-spin" /> : (t.notifyMeDesc || 'Підписатися')}
                                                    </button>
                                                    <div style={{ fontSize: '0.65rem', color: 'rgba(255,255,255,0.3)', fontWeight: '700', textAlign: 'center' }}>
                                                        {t.telegramIdHelp || 'Дізнатись свій ID можна через @userinfobot'}
                                                    </div>
                                                </>
                                            )}
                                        </div>
